	...
	<body id="position">
		<div id="wrapper">
			...
			<div id="header"><img src="../images/head.png">
				...
				<p class="p">First Name</br><input type="text" id="firstname" class="textbox" name="first"></br>
				<p class="p">Last Name</br><input type="text" id="lastname" class="textbox" name="last"></br>
				<p class="p">Email</br> <input type="text" id="email" placeholder="email@domain.com" class="textbox" name="email"></br>
				<p class="p">Birthday:</br>
					<select id="month" class="textbox" name="bdaymm">
					...
					<select id="day" class="textbox" name="bdaydd">
					...
					<select id="year" class="textbox" name="bdayyy">
				...
				<input class="submit" type="submit" value="Submit" onClick="return validReg();"/>
				</form>
