	...
	<body id="position">
		<div id="wrapper">
			...
			<div id="header"><img src="images/head.png">
				<div id="logo">
					<a href="#"><img src="images/LTO.png"></a>
				</div>
				
				<div>
					<img src="images/bg.jpg" id="bg">
					<p class="fonthead">Username or password is incorrect.</p>
					<a href="admin.php"><input type="button" class="tryagainbutton" value="TRY AGAIN"></a>
			...
			<div id="menubar">
				...
				<div>
					...
					<a title="Home" href="admin.php"><img class="adminbutton" src="images/admin.png"></a>
				</div>
			</div>
